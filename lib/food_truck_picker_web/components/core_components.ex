defmodule FoodTruckPickerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FoodTruckPickerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FoodTruckPickerWeb.Gettext, "errors", msg, opts)
    end
  end
